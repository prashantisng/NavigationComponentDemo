...
import com.example.navigationcomponentex2.databinding.FragmentEmailBinding
import com.example.navigationcomponentex2.databinding.FragmentNameBinding
    ...
    override fun onCreateView(
        ...
        binding.submitButton.setOnClickListener {
            if(!TextUtils.isEmpty(binding.emailText.text.toString())){
                ...
                it.findNavController().navigate(R.id.action_emailFragment_to_welcomeFragment2,bundle)
            }else{
